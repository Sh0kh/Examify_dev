...
export default function MultiLevelStartModal({ isOpen, onClose }) {
    ...
    const StartExam = async () => {
        try {
            ...
            await axiosAPI2.post(`/user/start-exam`, formData, {
                headers: {
        ...
        >
            ...
            >
                ...
                <div className="flex items-center justify-center gap-[30px] mt-[10px]">
                    <button onClick={StartExam} className="bg-[white] p-[10px] rounded-[5px] px-[20px] border-[2px] transition duration-500 hover:bg-transparent hover:text-[white]">
                        Start
                    </button>
                </div>
            </div>

        ...
        <div className="container">
            ...
            <div className="flex flex-wrap justify-around gap-10 mt-8">
                ...
                <div className="text-center">
                    ...
                    <p className="text-gray-600">Uzbekistan, Tashkent, Yunusabad</p>
                </div>
                <div className="text-center">
                    <div className="p-[12px] rounded-[50%] bg-[#F5F5F5] w-[48px] mx-auto">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
            ...
            <div className="mt-[120px] text-center">
                ...
                <form className="mt-8 space-y-4 max-w-lg mx-auto">
                    <div className="flex gap-4">
                        <input type="text" placeholder="First name" className="border p-2 w-1/2 rounded" required />
                        <input type="text" placeholder="Last name" className="border p-2 w-1/2 rounded" required />
                    </div>
                    ...
                    <textarea placeholder="Leave us a message..." className="border p-2 w-full h-28 rounded" required></textarea>
